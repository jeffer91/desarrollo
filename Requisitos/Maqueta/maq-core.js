...
(function(window,document){
  ...
  var state={moduloActivoId:null,moduloAnteriorId:null,moduloInicialId:"carga_excel",baseLocalReady:false};
  ...
  function makeFrame(modulo){
    ...
    iframe.addEventListener("load",function(){if(U.status)U.status("Pantalla activa: "+modulo.nombre);});
  ...
  window.MAQ_CORE={state:state,bus:{on:on,emit:emit},router:{navegarPorModuloId:navegarPorModuloId,pantallaAnterior:pantallaAnterior},actions:{refrescarModuloActivo:refrescarModuloActivo,ensureBaseLocalReady:ensureBaseLocalReady}};
})(window,document);
