/*
  Nombre completo: ta-titulo-articulo-functions-client.service.js
  Ruta o ubicación: /Requisitos/Titulos/src/services/ta-titulo-articulo-functions-client.service.js
  Función o funciones:
  - Centralizar llamadas hacia Netlify Functions.
  - Mantener separado el cliente de backend publicado del adaptador local.
  - Enviar acciones de estudiante, coordinador, administrador y Telegram sin repetir código.
  - Resolver URL de funciones para Netlify, Netlify Dev, Live Server, Vite, doble click y Electron cuando se use este origen.
*/
...
function getLocalStorageValue(key) {
  try {
    ...
    console.warn(`[Títulos Functions] No se pudo leer localStorage: ${error.message}`);
    return "";
  }
}
...
function setLocalStorageValue(key, value) {
  try {
    ...
    console.warn(`[Títulos Functions] No se pudo guardar localStorage: ${error.message}`);
  }
}
...
export const TaTituloArticuloFunctionsClient = Object.freeze({
  estudiante: {
