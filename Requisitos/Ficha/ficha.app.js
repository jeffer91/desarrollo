...
(function(window,document){
  ...
  function renderDetail(row){
    ...
    if(el("ficha-division-label"))el("ficha-division-label").textContent=row._division||"Sin división";
    el("ficha-periodo-label").textContent=row._periodo||"—";
    if(el("ficha-matricula-label"))el("ficha-matricula-label").textContent=row._estadoMatricula||"ACTIVO";
    el("ficha-sede").textContent=row._sede||"—";
