...
(function(window,document){
  ...
  function fillSelects(){var p=el("tabla-periodo");var c=el("tabla-carrera");var periods=window.TablaCore.periods();var careers=window.TablaCore.careers();if(p){p.innerHTML=option("","Todos",!state.periodId)+periods.map(function(x){return option(x.id,x.label||x.id,state.periodId===x.id);}).join("");}if(c){c.innerHTML=option("","Todas",!state.career)+careers.map(function(x){return option(x,x,state.career===x);}).join("");}}
