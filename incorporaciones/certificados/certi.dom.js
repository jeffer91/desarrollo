...
Ruta o ubicación: /incorporaciones/certificados/certi.dom.js
Función o funciones:
...
(function () {
  ...
  function obtener() {
    ...
    cache = {
      ...
      fuenteDatos: porId("certiFuenteDatos"),
      excelInput: porId("certiExcelInput"),
      textoInput: porId("certiTextoInput"),
      textoAyuda: porId("certiTextoAyuda"),
      bloqueExcel: porId("certiBloqueExcel"),
      bloqueTexto: porId("certiBloqueTexto"),
